        ...
        if results:
            ...
            for advocate in results:
                ...
                with st.expander(expander_label):
                  ...
                  # ============================================================================
                    # SAVE BUTTON - Saves to BOTH places regardless of email
                    # ============================================================================
                    st.markdown("---")
                            ...
                            if st.button("❤️ Save to My List", key=f"save_{advocate['id']}"):
                                if st.session_state.get('authenticated'):
                                    ...
                                    if conn:
                                        cur = conn.cursor()
                                        try:
                                            # ===== PART 1: Save to saved_readers table =====
                                            cur.execute("""
                                            ...
                                            # ===== PART 2: Save to CRM (ALWAYS, even without email) =====
                                            # Parse name
                                            first_name = ''
                                            last_name = ''
                                            ...
                                            # Insert into CRM - email can be NULL
                                            cur.execute("""
                                            ...
                                            """, (
                                                ...
                                                first_name,
                                                last_name,
                                                advocate.get('email'),  # This can be None
